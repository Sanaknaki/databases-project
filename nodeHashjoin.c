...
ExecHashJoin(HashJoinState *node)
{
    ...
    /*         return result; */
    /*     /1* Done with that source tuple... *1/ */
     ...
     */
    if (outer_hashtable == NULL && inner_hashtable == NULL)
    {
        /*
...
ExecInitHashJoin(HashJoin *node, EState *estate)
{
    ...
    outerPlanState(hjstate) = ExecInitNode((Plan *) inner_hashNode, estate); // CSI3130
    innerPlanState(hjstate) = ExecInitNode((Plan *) outer_hashNode, estate); // CSI3130
